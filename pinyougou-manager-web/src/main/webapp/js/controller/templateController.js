 //控制层 
app.controller('templateController' ,function($scope,$controller   ,templateService,brandService,specificationService){	
	...
	$scope.save=function(){				
		...
		if($scope.entity.id!=null){//如果有ID
			serviceObject=templateService.update( $scope.entity ); //修改  
		}else{
			serviceObject=templateService.add( $scope.entity  );//增加 
		}				
